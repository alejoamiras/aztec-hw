...
const cs_verb_entry_t CS_VERBS[CS_VERB_COUNT] = {
  { .selector_u32 = 0xaf28c76fu, .kind = 1, .verb = CS_VERB_TRANSFER_PRIV_PUB, .is_public = 0, .wire_arg_count = 4 },
  { .selector_u32 = 0xedc09d49u, .kind = 1, .verb = CS_VERB_TRANSFER_PRIV_PRIV, .is_public = 0, .wire_arg_count = 4 },
  { .selector_u32 = 0x32c5dcf8u, .kind = 1, .verb = CS_VERB_TRANSFER_PUB_PRIV, .is_public = 0, .wire_arg_count = 4 },
  ...
  { .selector_u32 = 0xf8f84119u, .kind = 1, .verb = CS_VERB_MINT_PRIV, .is_public = 0, .wire_arg_count = 2 },
  { .selector_u32 = 0x23d77f89u, .kind = 2, .verb = CS_VERB_SPONSOR, .is_public = 0, .wire_arg_count = 0 },
  { .selector_u32 = 0xbe46ea53u, .kind = 3, .verb = CS_VERB_DRIP_PUB, .is_public = 1, .wire_arg_count = 2 },
};
