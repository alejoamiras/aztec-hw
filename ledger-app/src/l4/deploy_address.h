 ...
 * Schnorr B3 consumer recompute + the Schnorr deploy verification. Emits
 * args_hash + init_hash too (same shape as the ECDSA fn) so the deploy 3-pass
 * fault check + FINALIZE recheck are scheme-uniform.
 */
