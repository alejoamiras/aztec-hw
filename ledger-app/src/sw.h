...
#define SW_DEPLOY_ADDRESS_MISMATCH        0x6F0E  // device-derived address != host expected_address (M8 P6)
#define SW_DEPLOY_PUBKEY_HASH_MISMATCH    0x6F0F  // device-derived publicKeysHash != host (M8 P6 sovereignty gate)
